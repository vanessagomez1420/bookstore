            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="sypnosis" id="sypnosis" class="form-control" placeholder="agregue la description del libro" required>{{ isset($book) ? $book->sypnosis : old('sypnosis') }}</textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="publisher_id" id="publisher_id" required>
                            ...
                            @if (isset($publishers))
                                @foreach ($publishers as $publisher)
                                    <option value="{{ $publisher->id }}" @if (isset($book) && $publisher->id == $book->publisher_id) selected @endif>
